# Graph Report - RPGACE  (2026-08-04)

## Corpus Check
- 198 files · ~443,893 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1073 nodes · 1438 edges · 184 communities (174 shown, 10 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 28 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `51be0aff`
...
## Communities (184 total, 10 thin omitted)
...
### Community 1 - "main.js"
Cohesion: 0.03
Nodes (48): acceptSuggestions(), beginSession(), buildAllQuests(), buildQS(), CAT_COL, CAT_ICON, closeSessionSetup(), closeSuggestion() (+40 more)
...
Cohesion: 0.16
Nodes (14): acceptJumpToEnc(), clearScheduledAgendas(), exitFocusToEnc(), generateContentIdeasFromInsights(), goToEncFromFocus(), loadNote(), loadScheduledAgendas(), pushLocalToSupabase() (+6 more)

### Community 6 - "renderEncEntries"
Cohesion: 0.11
Nodes (24): approveInsights(), approveInsightsFromCache(), autoExtractAllInCategory(), deleteEncEntry(), detectCategory(), ENC_ALL_ENTRIES, extractInsightsAuto(), extractInsightsSemiAuto() (+16 more)
...
Cohesion: 0.10
Nodes (29): _addSchedButtons(), buildMonthSlots(), buildWeekSlots(), _calCellItems(), _calDateStr(), _calFmtShort(), _calGetSchedAgendas(), _calGetShifts() (+21 more)
...
Cohesion: 0.15
Nodes (17): AGENT_ACTIONS, buildAgentActions(), buildSkillTree(), buildTimeSlots(), checkPassword(), deleteNote(), initApp(), initLearning() (+9 more)
...
### Community 14 - "generateAgendas"
Cohesion: 0.28
Nodes (9): closePasteRota(), generateAgendas(), getFreeWindows(), getShiftContext(), getShifts(), getShiftsForDate(), getTodayShifts(), parseAndSaveRota() (+1 more)

### Community 15 - "sendChat"
Cohesion: 0.13
Nodes (19): addMsg(), checkForQuestSuggestions(), _escChatHtml(), extractVSTsFromText(), fireBeatAnalysis(), fireInstaCommand(), fireProdCommand(), isInstaOracleQuery() (+11 more)
...
Cohesion: 0.27
Nodes (10): applyShifts(), autoApplyStoredShifts(), dzDrop(), dzLeave(), handleFile(), parseCSV(), parseICS(), parsePasteInput() (+2 more)
...
## Knowledge Gaps
- **395 isolated node(s):** `MODEL_EXTRACTOR`, `MODEL_GROUND_WORKER`, `TYPE_PROMPTS`, `config`, `CONFIG` (+390 more)
...
- **Why does `cmd_add()` connect `rpgace_build.py` to `rpgace_intel.py`?**
...
- **Should `main.js` be split into smaller, more focused modules?**
  _Cohesion score 0.03349282296650718 - nodes in this community are weakly interconnected._
