...
- **Omnitrix formalized (July 20):** the Fable→Opus 4.8→Sonnet 5 workflow used across all three July 19-20 builds is now a named, invokable protocol — see "Invokable frameworks" below.
...
## Invokable frameworks — Omnitrix, Council of 5, GODMODE (Alex-confirmed July 20)
Three named protocols. Saying the name in chat activates the full protocol for the task at hand — treat the word itself as the instruction.
