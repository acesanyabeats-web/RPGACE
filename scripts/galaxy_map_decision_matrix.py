...
TEXT_INPUT_POINTS = [
    ...
    },
    {
        ...
        'module': 'visualOracle', 'lines': (7145, 7163),  # re-verified Sep 15 2026 (real wiring-sweep pass), drifted +32 lines from 7050-7067 due to real code changes earlier in the file since Sep 8
