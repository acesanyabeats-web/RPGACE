...
DECISION_POINTS = [
    {
        ...
        'module': 'intelDelete', 'func': '_confirm', 'lines': (13887, 13928),  # re-verified Sep 8 2026 (/Routine), drifted from 10810 due to the G53 60-module ui/logic split
    ...
    },
    {
        ...
        'module': 'videoSummary', 'func': '_delete', 'lines': (15963, 15977),  # re-verified Sep 15 2026 (real wiring-sweep pass), drifted +42 lines from 15818-15837 due to real code changes earlier in the file since Sep 8
    ...
    },
    {
        ...
        'module': 'conidPot', 'func': '_refreshIdeaBank', 'lines': (29324, 29324),  # re-verified Sep 16 2026 (Galaxy Map redevelopment /CEO pass), drifted +9 lines from 29227 due to the GMR-1 fal.ai/OpenArt edit earlier in the file
    ...
    },
    {
        ...
        'module': 'bookworm', 'func': '_refreshWidget', 'lines': (21517, 21525),  # re-verified Sep 15 2026 (real wiring-sweep pass), drifted +48 lines from 21376-21386 due to real code changes earlier in the file since Sep 8
    ...
    },
    {
        ...
        'module': 'phylumPath', 'func': '_showPlacementConfirm', 'lines': (19378, 19378),  # re-verified Sep 16 2026 (found via a routine full pipeline run, not a dedicated sweep), drifted +1 line from 19289-19289; re-confirmed against the real pass-through wrapper (a 2nd match at 19870) -- 19290 is the real ui:{} implementation
    ...
    },
    {
        ...
        'module': 'taxonomyReviewQueue', 'func': '_acceptPhylumPathProposal', 'lines': (11622, 11622),  # re-verified Sep 15 2026 (real wiring-sweep pass), drifted +34 lines from 11500-11500; also confirmed against the real pass-through wrapper (a 2nd match at 12013) -- 11534 is the real logic:{} implementation
    ...
    },
    {
        ...
        'module': 'taxonomyReviewQueue', 'func': '_acceptConceptFusion', 'lines': (11656, 11656),  # re-verified Sep 15 2026 (real wiring-sweep pass), drifted +34 lines from 11534-11534; also confirmed against the real pass-through wrapper (a 2nd match at 12014) -- 11568 is the real logic:{} implementation
    ...
    },
    {
        ...
        'module': 'taxonomyReviewQueue', 'func': '_editPhylumPathProposal', 'lines': (11708, 11708),  # re-verified Sep 15 2026 (real wiring-sweep pass), drifted +34 lines from 11586-11586; also confirmed against the real pass-through wrapper (a 2nd match at 12015) -- 11620 is the real logic:{} implementation
    ...
    },
    {
        ...
        'module': 'contentProductionLive', 'func': '_undoLastStage', 'lines': (25864, 25864),  # re-verified Sep 16 2026 (found via a routine full pipeline run), drifted +1 line from 25775-25775
