...
DECISION_POINTS = [
    {
        ...
        'module': 'intelDelete', 'func': '_confirm', 'lines': (13885, 13926),  # re-verified Sep 23 2026 (Minotaur/Manual Unification follow-up anchor sweep), drifted -2 lines from 13887-13928; re-confirmed against the real pass-through wrapper (a 2nd match at 14120) -- 13885 is the real ui:{} implementation, not the wrapper
    ...
    },
    {
        ...
        'module': 'videoSummary', 'func': '_delete', 'lines': (15960, 15974),  # re-verified Sep 23 2026 (Minotaur/Manual Unification follow-up anchor sweep), drifted -3 lines from 15963-15977
    ...
    },
    {
        ...
        'module': 'conidPot', 'func': '_refreshIdeaBank', 'lines': (29321, 29321),  # re-verified Sep 23 2026 (Minotaur/Manual Unification follow-up anchor sweep), drifted -3 lines from 29324
    ...
    },
    {
        ...
        'module': 'bookworm', 'func': '_refreshWidget', 'lines': (21514, 21522),  # re-verified Sep 23 2026 (Minotaur/Manual Unification follow-up anchor sweep), drifted -3 lines from 21517-21525
    ...
    },
    {
        ...
        'module': 'phylumPath', 'func': '_showPlacementConfirm', 'lines': (19375, 19375),  # re-verified Sep 23 2026 (Minotaur/Manual Unification follow-up anchor sweep), drifted -3 lines from 19378-19378; re-confirmed against the real pass-through wrapper (a 2nd match at 19955) -- 19375 is the real ui:{} implementation
    ...
    },
    {
        ...
        'module': 'phylumPath', 'func': '_showArticleConfirm', 'lines': (19457, 19457),  # re-verified Sep 23 2026 (Minotaur/Manual Unification follow-up anchor sweep), drifted -3 lines from 19460-19460, same class as placement-confirm above; re-confirmed against the real pass-through wrapper (a 2nd match at 19956) -- 19457 is the real ui:{} implementation
    ...
    },
    {
        ...
        'module': 'taxonomyReviewQueue', 'func': '_acceptPhylumPathProposal', 'lines': (11620, 11620),  # re-verified Sep 23 2026 (Minotaur/Manual Unification follow-up anchor sweep), drifted -2 lines from 11622-11622; re-confirmed against the real pass-through wrapper (a 2nd match at 12099) -- 11620 is the real logic:{} implementation
    ...
    },
    {
        ...
        'module': 'taxonomyReviewQueue', 'func': '_acceptConceptFusion', 'lines': (11654, 11654),  # re-verified Sep 23 2026 (Minotaur/Manual Unification follow-up anchor sweep), drifted -2 lines from 11656-11656; re-confirmed against the real pass-through wrapper (a 2nd match at 12100) -- 11654 is the real logic:{} implementation
    ...
    },
    {
        ...
        'module': 'taxonomyReviewQueue', 'func': '_editPhylumPathProposal', 'lines': (11706, 11706),  # re-verified Sep 23 2026 (Minotaur/Manual Unification follow-up anchor sweep), drifted -2 lines from 11708-11708; re-confirmed against the real pass-through wrapper (a 2nd match at 12101) -- 11706 is the real logic:{} implementation
    ...
    },
    {
        ...
        'module': 'contentProductionLive', 'func': '_undoLastStage', 'lines': (25861, 25861),  # re-verified Sep 23 2026 (Minotaur/Manual Unification follow-up anchor sweep), drifted -3 lines from 25864-25864
