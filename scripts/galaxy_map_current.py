...
PLAIN_ENGLISH = {
    ...
    ('refCorpus', 'findMatches'): {
        ...
        'lines': (25371, 25404),  # re-verified Sep 15 2026 (real wiring-sweep pass), drifted +56 lines from 25315-25369; also confirmed against a 2nd real match, the thin top-level pass-through wrapper at 25431 -- 25371 is the real logic:{} implementation
    ...
    ('conidPot', '_quickDetectPhyla'): {
        ...
        'lines': (28716, 28725),  # re-verified Sep 15 2026 (real wiring-sweep pass), drifted +56 lines from 28660-28671; also confirmed against a 2nd real match, the thin top-level pass-through wrapper at 29312 -- 28716 is the real logic:{} implementation
