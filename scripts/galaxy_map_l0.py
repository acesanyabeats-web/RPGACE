...
<div style="max-width:820px;margin:12px auto 0;padding:9px 20px;text-align:center;font-size:11px;color:#8a8a9a">
  Real Aug 21 2026 update: this page's 7 units are now merged directly into <a href="galaxy_map.html">galaxy_map.html</a> — RPGACE Total Systems' own real architecture map — alongside its 4 galaxies, all 9 sharing one working Infra/Inter facet picker. This page stays live as real reference for the original 17 hand-curated edges, but <a href="galaxy_map.html">galaxy_map.html</a> is the correct place to start.
</div>
<div class="hero">
