...
EDGES = [
    ...
    {'id': 'alex-oracle', 'a': 'alex', 'b': 'oracle', 'kind': ACTOR,
    ...
    {'id': 'rpgace-oracle', 'a': 'rpgace_architecture', 'b': 'oracle', 'kind': ACTOR,
    ...
    {'id': 'oracle-oversight', 'a': 'oracle', 'b': 'oversight_docs', 'kind': ACTOR,
