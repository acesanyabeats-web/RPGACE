...
<div class="toggle-row">
  <div class="toggle-btn active" data-view="deps">🔗 Shared dependencies</div>
  <div class="toggle-btn" data-view="table">📊 By family</div>
</div>
<div class="view active" id="view-deps">{dep_bubbles}</div>
<div class="view" id="view-table">{sections}</div>
{dim_index}
<!-- Real Table/Deps toggle-click handling now lives ONCE in the shared
