...
- → [[13 — River XIII — Skills.md|River XIII — Skills]] — **Passive read at session start** (feeds Routine's own session-start check via session_memory, read at the start of every future session)
