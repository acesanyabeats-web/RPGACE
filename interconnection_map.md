...
**Status:** confirmed, final spec locked — ready to build starting with the 4 Oracle panel buttons (highest-traffic surface) since wrapping the shared function covers all 12 known call sites simultaneously.
